import { _ as _defineProperty, e as _toConsumableArray } from './chunk-94a101ab.js';
...
import { C as Checkbox } from './chunk-78b3e262.js';
import { S as Select } from './chunk-4615c329.js';
import { P as Pagination } from './chunk-ed64505c.js';
...
var script$2 = {
  name: 'BTable',
  components: _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, Checkbox.name, Checkbox), Icon.name, Icon), Input.name, Input), Pagination.name, Pagination), SlotComponent.name, SlotComponent), __vue_component__.name, __vue_component__), __vue_component__$1.name, __vue_component__$1),
  props: {
    data: {
      type: Array,
