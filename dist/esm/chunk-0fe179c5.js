  ...
  computed: {
    ...
    */
    ...
    isMobile: function isMobile$1() {
      console.log('>>> conditions', this.mobileNative, isMobile.any(), this.readonly); // eslint-disable-line no-console
