...
(function (global, factory) {
  ...
  var script$a = {
    name: 'BDatepicker',
    components: _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, __vue_component__$8.name, __vue_component__$8), __vue_component__$9.name, __vue_component__$9), __vue_component__$3.name, __vue_component__$3), __vue_component__$5.name, __vue_component__$5), __vue_component__$6.name, __vue_component__$6), __vue_component__$2.name, __vue_component__$2), __vue_component__.name, __vue_component__), __vue_component__$1.name, __vue_component__$1),
    mixins: [FormElementMixin],
    inheritAttrs: false,
    props: {
      value: {
  ...
  var script$b = {
    name: 'BTimepicker',
    components: _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, __vue_component__$3.name, __vue_component__$3), __vue_component__$5.name, __vue_component__$5), __vue_component__$6.name, __vue_component__$6), __vue_component__$2.name, __vue_component__$2), __vue_component__.name, __vue_component__), __vue_component__$1.name, __vue_component__$1),
  ...
  var script$c = {
    ...
    components: _defineProperty(_defineProperty({}, __vue_component__$a.name, __vue_component__$a), __vue_component__$b.name, __vue_component__$b),
    mixins: [FormElementMixin],
    inheritAttrs: false,
    props: {
      value: {
