...
var script = {
  name: 'BTimepicker',
  components: __chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty({}, __chunk_6.Input.name, __chunk_6.Input), __chunk_13.Field.name, __chunk_13.Field), __chunk_14.Select.name, __chunk_14.Select), __chunk_4.Icon.name, __chunk_4.Icon), __chunk_12.Dropdown.name, __chunk_12.Dropdown), __chunk_12.DropdownItem.name, __chunk_12.DropdownItem),
