...
var script$3 = {
  name: 'BDatepicker',
  components: __chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty({}, __vue_component__$1.name, __vue_component__$1), __vue_component__$2.name, __vue_component__$2), __chunk_6.Input.name, __chunk_6.Input), __chunk_13.Field.name, __chunk_13.Field), __chunk_14.Select.name, __chunk_14.Select), __chunk_4.Icon.name, __chunk_4.Icon), __chunk_12.Dropdown.name, __chunk_12.Dropdown), __chunk_12.DropdownItem.name, __chunk_12.DropdownItem),
