...
var __chunk_9 = require('./chunk-5cb77942.js');
...
var script = {
  ...
  components: __chunk_1._defineProperty(__chunk_1._defineProperty({}, __chunk_14.Select.name, __chunk_14.Select), __chunk_4.Icon.name, __chunk_4.Icon),
  props: {
...
var script$2 = {
  name: 'BTable',
  components: __chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty(__chunk_1._defineProperty({}, __chunk_9.Checkbox.name, __chunk_9.Checkbox), __chunk_4.Icon.name, __chunk_4.Icon), __chunk_6.Input.name, __chunk_6.Input), __chunk_21.Pagination.name, __chunk_21.Pagination), __chunk_23.SlotComponent.name, __chunk_23.SlotComponent), __vue_component__.name, __vue_component__), __vue_component__$1.name, __vue_component__$1),
  props: {
    data: {
      type: Array,
